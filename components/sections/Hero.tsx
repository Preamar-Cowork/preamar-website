...
export function Hero({
  ...
  const logoSrc =
    s.theme === "escuro"
      ? "/logos/lockup-preamar-transparente-escuro.svg"
      : "/logos/lockup-preamar-transparente-claro.svg";
  ...
  return (
    ...
    >
      ...
      {/* top row: descriptor + tide clock */}
      <div className="relative z-10 flex justify-between items-start p-6 md:p-10">
        <div className="font-label font-bold text-[10px] md:text-[11px] tracking-[0.18em] uppercase opacity-80">
          Espaços de trabalho · Montijo
        </div>
        <div className="font-label font-semibold text-[10px] md:text-[11px] tracking-[0.15em] uppercase text-right leading-relaxed">
      ...
      <div className={`relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 ${contained ? "pb-[8%]" : "pb-[9vh]"}`}>
        ...
        <motion.img
          ...
          style={{ width: s.logoWidth, maxWidth: "82%" }}
          draggable={false}
          {...(reduce
            ? {}
            : {
        ...
        {s.tagline && contained && (
          <h1
            className={`${FONT_CLASS[s.taglineFont]} leading-[1.1] mt-8 md:mt-10`}
